...
class TrainData(data.Dataset):
    ...
    def __init__(self, crop_size, train_data_dir):
        ...
        self.haze_dir = train_data_dir + 'haze/'
...
class ValData(data.Dataset):
    def __init__(self, val_data_dir):
        ...
        self.haze_dir = val_data_dir + 'hazy/'
        self.gt_dir = val_data_dir + 'gt/'
...
class ValData_AECR(data.Dataset):
    def __init__(self, val_data_dir):
        super().__init__()
    ...
    def get_images(self, index):
        ...
        haze_reshaped = transform_haze(haze_reshaped)
        gt = transform_gt(gt_img)
        foggy_img = transform_gt(haze_img)
        ...
        return haze, haze_reshaped, gt, haze_name, in_data, foggy_img
...
class TestData_AECR(data.Dataset):
    def __init__(self, val_data_dir):
        super().__init__()
    ...
    def get_images(self, index):
        ...
        return haze, haze_reshaped, haze_name, foggy_img, in_data
